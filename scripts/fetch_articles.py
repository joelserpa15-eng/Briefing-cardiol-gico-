...
SUBSPECIALTIES = [
    ...
    },
    {
        ...
        "name": "Insuficiencia Cardíaca y Dispositivos",
        "color": "#2471A3",
        "keywords": [
            # IC crónica — fenotipos y biomarcadores
            ...
            # IC optimizada — farmacología
            "sglt2 inhibitor", "dapagliflozin", "empagliflozin", "sotagliflozin",
            "sacubitril", "valsartan", "angiotensin receptor neprilysin",
            "ivabradine", "finerenone", "vericiguat",
            "iron deficiency heart failure", "ferric carboxymaltose",
            "spironolactone heart failure", "eplerenone heart failure",
            # IC avanzada
            "advanced heart failure", "end-stage heart failure",
            "refractory heart failure", "stage d heart failure",
            "inotrope dependence", "dobutamine infusion", "milrinone infusion",
            "levosimendan heart failure", "omecamtiv",
            "cardiac cachexia", "palliative heart failure",
            # Dispositivos de asistencia ventricular — durable / crónico
            "left ventricular assist device", "lvad", "ventricular assist device",
            "heartmate 3", "heartmate ii", "heartmate 2",
            "heartware", "hvad", "jarvik",
            ...
            "pump thrombosis", "driveline infection",
            "device-related adverse event lvad",
            # Trasplante cardíaco
            "heart transplantation", "orthotopic heart transplantation",
            "cardiac allograft", "cardiac allograft vasculopathy",
            "heart transplant rejection", "primary graft dysfunction",
            "donor heart allocation", "heart allocation",
            "immunosuppression transplant", "tacrolimus transplant",
            # Resincronización en IC (diferenciado de arritmias puras)
            "cardiac resynchronization therapy heart failure",
            "crt heart failure", "crt-d heart failure",
        ],
        "mesh": [
